...
public class Course {
    ...
    private List<String> listOfInstructors = new ArrayList<String>();
    ...
    public List<String> getListOfInstructors() {
	return listOfInstructors;
    }

    public void setListOfInstructors(List<String> listOfInstructors) {
    ...
    public double calculateTotalPrice() {
    	double totalPrice = this.getNumberOfDays() * this.getPricePerDay();
    	if (this.getNumberOfDays() > 3 && this.isPriorKnowledgeRequired()) {
	...
	bufferedWriter.write("Title : "+this.getTitle()+"\n");
	bufferedWriter.write("Number of days : "+ this.getNumberOfDays()+"\n");
	bufferedWriter.write("Price per day : "+ this.getPricePerDay()+"\n");
	bufferedWriter.write("Prior knowledge required : "+ this.isPriorKnowledgeRequired()+"\n");
	bufferedWriter.write("Number of instructors : "+ this.getListOfInstructors().size()+"\n");
	for (String instructor : this.getListOfInstructors()) {
	   bufferedWriter.write("Instructor : "+ instructor+"\n");
	}
	bufferedWriter.write("Total price : "+ this.calculateTotalPrice() + " ("+this.getLabel()+")\n");
	bufferedWriter.write("=======================================================================\n");
    }

    public void addInstructor(String instructor) {
	this.getListOfInstructors().add(instructor);
    }

    public void removeInstructor(int index) {
	this.getListOfInstructors().remove(index);
    }
